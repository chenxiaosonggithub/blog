...
启动脚本[`start.sh`](https://github.com/chenxiaosonggithub/blog/blob/master/src/docker/start.sh)。
...
脚本[`update-image.sh`](https://github.com/chenxiaosonggithub/blog/blob/master/src/docker/update-image.sh)。
