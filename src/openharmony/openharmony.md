...
合入补丁[0001-fuse-read-debug-dentry_meta_file_test-tdd.patch](https://github.com/chenxiaosonggithub/blog/blob/master/src/openharmony/0001-fuse-read-debug-dentry_meta_file_test-tdd.patch)后，编译和运行tdd：
```sh
