...
# openEuler贡献 {#openeuler}

除了[Linux内核上游的补丁](https://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git/log/?qt=grep&q=chenxiaosong)回合到openEuler外，还有只合到openEuler社区的补丁贡献:
...
# ghostwriter: markdown编辑器 {#ghostwriter}
