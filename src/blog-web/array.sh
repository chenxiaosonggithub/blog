...
comm_array=(
	...
	0 1 course/nfs/nfs.md ~ "nfs文件系统"
		...
		1 1 course/nfs/openeuler-enfs.md ~ "openEuler的nfs+"
			...
			1 1 course/nfs/openeuler-enfs/enfs-server-not-responding.md ~ "openEuler的nfs+报错not responding的问题"
			1 1 course/nfs/openeuler-enfs/enfs-recreate-shard-info.md ~ "openEuler的nfs+重新插入enfs模块时生成shard信息的功能"
			1 1 course/nfs/openeuler-enfs/enfs-unstable-path-state.md ~ "openEuler的nfs+增加亚健康连接状态"
	...
	1 1 tmp/calligraphy/written.md calligraphy/written.html "左手写过的字"
	...
	1 2 en/FILE_SYSTEM_ATTRIBUTE_INFO.md ~ "Test FILE_SYSTEM_ATTRIBUTE_INFO"
	1 2 tmp/gnu-linux/smb/test/20251109/README.md en/smb-test-20251109.html "SMB Test Results on 2025-11-09"
	...
	1 2 tmp/gnu-linux/smb/test/20251210/README.md en/smb-test-20251210.html "SMB Test Results on 2025-12-10"
	...
	1 2 tmp/gnu-linux/smb/test/buildbot/buildbot.md en/smb-buildbot.html "SMB buildbot test"
)
