...
`git log fs/btrfs/`中有一个补丁日志有点像，[0d977e0eba23 btrfs: reset replace target device to allocation state on close](https://lore.kernel.org/all/20210820175040.586806-1-desmondcheongzx@gmail.com/)，先不管涉不涉及，先记录着。
