...
- [ksmbd挂载日志](https://github.com/chenxiaosonggithub/tmp/blob/master/smb/mount/ksmbd-log.txt)
- [client挂载日志](https://github.com/chenxiaosonggithub/tmp/blob/master/smb/mount/client-log.txt)

# tcpdump抓包数据

[点击这里下载抓包数据文件](https://github.com/chenxiaosonggithub/tmp/blob/master/smb/mount/mount.cap)。
