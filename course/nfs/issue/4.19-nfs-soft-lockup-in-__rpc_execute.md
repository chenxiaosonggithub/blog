...
[点击这里查看`bt -g 227403`的输出](https://gitee.com/chenxiaosonggitee/tmp/blob/master/linux/nfs/nfs-soft-lockup-in-__rpc_execute-crash-vmcore-bt-g-227403.txt)。
...
[从vmcore的解析`bt -g 227403`的输出](https://gitee.com/chenxiaosonggitee/tmp/blob/master/linux/nfs/nfs-soft-lockup-in-__rpc_execute-crash-vmcore-bt-g-227403.txt)可以看到进程组里没有一个进程在等待异步rpc读的回复。
