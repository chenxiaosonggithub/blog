...
[微信apk文件](https://weixin.qq.com/)用[Apktool M](https://maximoff.su/apktool/?lang=en)处理后在“卓易通”中安装能正常使用，
有些软件如“蓝信”、“VLC”等不需要用[Apktool M](https://maximoff.su/apktool/?lang=en)处理而是可以直接在“卓易通”中安装。
