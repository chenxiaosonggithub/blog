...
sudo apt install ./phddns_5.3.0_amd64.deb -y
...
- [快解析](https://www.kuaijiexi.com/technology/153.html): 暂时没成功
  - [下载windows和linux版本](https://www.kuaijiexi.com/download.html)
  - [注册完成引导](https://www.kuaijiexi.com/kjxRegister?username=chenxiaosong)
  - [内网穿透快解析保姆级使用教程？](https://www.kuaijiexi.com/Instructions/46.html)
  - [注册快解析网页添加映射填写说明？](https://www.kuaijiexi.com/technology/277.html)
...
[ubuntu通过命令行操作wifi](https://chenxiaosong.com/course/gnu-linux/install.html#ubuntu-cmd-wifi)。
...
- 字体大小: 使用音量键调节字体大小
- 弹出键盘: 点击终端以显示弹出键盘，该键盘拥有常用的特殊按键（比如Ctrl、方向键等）。向右滑动来启用/禁用自动补全（在IRC中很有用）
- 复制与粘帖/保存副本/隐藏键盘: 在终端中长按便可以复制、粘帖、分享或保存会话副本
