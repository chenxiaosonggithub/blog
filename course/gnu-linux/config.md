...
执行脚本[`copy-to-home.sh`](https://gitee.com/chenxiaosonggitee/blog/blob/master/course/gnu-linux/src/config-file/copy-to-home.sh)
复制配置文件到家目录下。
...
让某个窗口执行命令: `tmux send-keys -t qemu02 'bash start.sh' C-m`
