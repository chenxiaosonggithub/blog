...
- [399aa12450a6 ksmbd: zero the FS_OBJECT_ID_INFORMATION buffer before filling it in](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=399aa12450a6)
- Review: [448ba0ae65ca smb/client: invalidate fscache for fallocate range operations](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=448ba0ae65ca)
- Review: [01261a6fa48b smb/client: fix stale page cache in insert/collapse range](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=01261a6fa48b)
- Review: [7811701d6af7 smb/client: fix integer truncation in collapse range](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=7811701d6af7)
- Review: [0923ae9f23cc smb/client: fix data corruption in emulated insert range](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=0923ae9f23cc)
- Review: [cd03ce4950d8 smb/client: mark file sparse before emulating insert range](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=cd03ce4950d8)
- Review: [88972e357507 smb/client: validate new EOF for zero range](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=88972e357507)
- Review: [1519dc88c87f smb/client: validate new EOF for insert range](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=1519dc88c87f)
- [13b1d8a99687 MAINTAINERS: add myself as KSMBD reviewer](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=13b1d8a99687)
- [77d852c76342 smb/client: fix nlink of an overwritten open file](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=77d852c76342)
- Review: [b1b741cf8e7c smb: client: clear ce->tgthint in free_tgts()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=b1b741cf8e7c)
- Review: [bf86c08123c6 smb: client: harden DFS cache against invalid target hints](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=bf86c08123c6)
- [a2f9fb451c68 smb/client: return EOPNOTSUPP for unsupported O_TMPFILE](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=a2f9fb451c68)
- Review: [7de5cf9bcf96 smb/server: fix session counter on session removal](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=7de5cf9bcf96)
- Review: [492b24b5b651 smb/server: update session counter under sessions table lock](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=492b24b5b651)
- Review: [99b25b046e47 smb/server: fix session leak in ksmbd_session_register()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=99b25b046e47)
- Review: [9a74739026fb smb/server: warn if ksmbd_proc_create() fails](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=9a74739026fb)
- Review: [79decd88dd3f ksmbd: bound smb_check_perm_dacl() ACE walks by DACL size](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=79decd88dd3f)
- Review: [39f203209671 smb/server: fix tree connection leak in smb2_tree_connect()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=39f203209671)
- [93a3cda16124 smb/server: fix use-after-free in ksmbd_conn_transport_destroy()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=93a3cda16124)
- Review: [215e8816b1ac ksmbd: detach blocked lock requests before freeing](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=215e8816b1ac)
- [6a8292d379d6 smb/server: deny overwriting targets with non-POSIX opens](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=6a8292d379d6)
- [1e3b4b4f7768 smb/server: rename to ksmbd_has_nonposix_open_child()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=1e3b4b4f7768)
- [2d99fbd7ad36 smb/server: fix posix state check for directory rename](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=2d99fbd7ad36)
- Review: [a3bcea7c819a ksmbd: exempt FSCTL_PIPE_TRANSCEIVE from the generic file-id lookup](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=a3bcea7c819a)
- Review: [73541bd2bab7 smb/server: preserve error status in smb2_handle_negotiate()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=73541bd2bab7)
- Review: [f43cbe3b58ce smb/server: call ksmbd_proc_cleanup() on module init failure](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=f43cbe3b58ce)
- Review: [db97f3763727 smb/server: abort initialization when proc setup fails](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=db97f3763727)
- Review: [bef46b604732 smb/server: fix invalid pointer dereference in ksmbd_stop_durable_scavenger()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=bef46b604732)
- Review: [3ce2f9491963 smb/server: fix memory leak in ksmbd_vfs_set_durable_owner()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=3ce2f9491963)
- Review: [d2ccf905f47d smb/server: fix null-ptr-deref in ksmbd_ipc_tree_connect_request()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=d2ccf905f47d)
- Review: [6eac877e0ea5 ksmbd: remove extra byte from ipc_msg_alloc() size calculations](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=6eac877e0ea5)
- [f39ec312c3eb smb/server: fix unbuffered file position alignment check](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=f39ec312c3eb)
- Review: [3f220a0a62e6 ksmbd: only rebind the reopened file's own oplock on durable reconnect](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=3f220a0a62e6)
- [528af7cf69f3 smb/server: avoid registering async requests during connection close](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=528af7cf69f3)
- [4fd5bad647bf smb/server: cancel async requests when closing connection](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=4fd5bad647bf)
- [df3e2150f3ea smb/server: fix signing when a response uses more than one iov](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=df3e2150f3ea)
- [49f6a485868e smb/server: use MSG_EOR for async interim response](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=49f6a485868e)
- [0977715850ac smb/server: introduce struct ksmbd_transport_write](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=0977715850ac)
- [906a62216339 smb/server: send compound prefix before async pending response](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=906a62216339)
- Review: [ba3afa8ccd15 ksmbd: validate compression Flags before kvmalloc](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=ba3afa8ccd15)
- Review: [0710dd08824a smb: compress: reject Pattern_V1 when not negotiated](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=0710dd08824a)
- [c422d34a4ad9 smb/client: show compress mount option](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=c422d34a4ad9)
- Review: [9388e7c820e3 smb: client: free partially allocated transform folio queue](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=9388e7c820e3)
- Review: [2bebf2470af1 ksmbd: enforce signing required by the session](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=2bebf2470af1)
- Review: [d7d2adcd022b smb/client: flush dirty data before punching a hole](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=d7d2adcd022b)
- Review: [e2e08effef2c smb/client: Use EXPORT_SYMBOL_IF_KUNIT() to export symbols in SMB2](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=e2e08effef2c)
- Review: [b8de511f0e80 smb/client: Use EXPORT_SYMBOL_IF_KUNIT() to export symbols](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=b8de511f0e80)
- Review: [5bd1d3dcc25a smb/client: refresh allocation after EOF-extending fallocate](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=5bd1d3dcc25a)
- Review: [7a06d3b816d7 smb/client: emulate small EOF-extending mode 0 fallocate ranges](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=7a06d3b816d7)
- Review: [9e4ec3be67af smb/client: reduce fallocate zero buffer allocation](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=9e4ec3be67af)
- Review: [b09ae45d85dc smb/client: handle overlapping allocated ranges in fallocate](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=b09ae45d85dc)
- Review: [5906d0e82e8e smb/client: refresh allocation size after duplicate extents](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=5906d0e82e8e)
- [9dd1964ac59d smb/client: fix incorrect nlink returned by fstat()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=9dd1964ac59d)
- [8fce4cf4369c smb/client: zero-initialize stack-allocated cifs_open_info_data](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=8fce4cf4369c)
- [1f551e407bb4 smb/client: pass cifs_open_info_data to SMB2_open()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=1f551e407bb4)
- [fc8789bb57e6 smb/client: use stack-allocated smb2_file_all_info in smb3_query_mf_symlink()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=fc8789bb57e6)
- Review: [216c5aba4ebd smb/server: map SET_INFO ENOSPC to disk full](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=216c5aba4ebd)
- [64f04f978923 netfs: Fix DIO write retry for filesystems without a ->prepare_write()](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=64f04f978923)
- [851ed9e09639 smb/server: do not require delete access for non-replacing links](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=851ed9e09639)
- Review: [47f0b34f6bc9 ksmbd: validate num_subauth when copying ACE in set_ntacl_dacl](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=47f0b34f6bc9)
- Review: [60908f7ebcd9 ksmbd: reject undersized DACLs before parsing ACEs](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=60908f7ebcd9)
- Review: [7ac657bb9c5c ksmbd: fix n.data memory leak in ksmbd_vfs_set_dos_attrib_xattr](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=7ac657bb9c5c)
- Review: [d708a36634bb ksmbd: Fix acl.sd_buf memory leak and invalid sd_size error handling](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=d708a36634bb)
- Review: [d4d56b00c7df ksmbd: fix sd_ndr.data memory leak in ksmbd_vfs_set_sd_xattr](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=d4d56b00c7df)
