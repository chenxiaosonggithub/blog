...
The following patches were applied to the mainline for testing:
  ...
  - Patches applied to the mainline from [[PATCH v3 00/22] smb: fix some bugs, move duplicate definitions to common header file](https://lore.kernel.org/all/20251014071917.3004573-1-chenxiaosong.chenxiaosong@linux.dev/):
