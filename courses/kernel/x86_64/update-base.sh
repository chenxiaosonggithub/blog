...
-smp 16 \
-m 4096 \
-kernel ${HOME}/chenxiaosong/code/$kernel_version/build/arch/x86/boot/bzImage \
-virtfs local,id=kmod_dev,path=${HOME}/chenxiaosong/,readonly,mount_tag=9p,security_model=none \
-vga none \
-nographic \
